...
#换成自己的appid  
    ...
    options = {}
    options["face_field"] = "age,gender,emotion,beauty"
        ...
        if i['face_probability']>0.8:
            ...
            for i in range(face_num):
                ...
                if json1['error_msg']=='SUCCESS':
                    user_attribute = []
                    user_type = '员工'
                    user_result = {'is_user':is_user,'user_type':user_type,'user_attribute':user_attribute}
                    ...
                    if json1['result']['face_list'][0]['user_list'][i]['score']>70:
                        ...
                        cv2.putText(image, f"{str(face_data['result']['face_list'][i]['age'])} {face_data['result']['face_list'][i]['gender']['type']}", (x, y), cv2.FONT_HERSHEY_SIMPLEX, 1.2, (255, 255, 255), 2)
                    ls.append(image)
